...
integration('development instrument seed', () => {
  ...
  beforeEach(async () => { await pool.query('TRUNCATE TABLE line_webhook_events, transactions, transaction_drafts, position_snapshots, instruments, portfolios, user_identities, users CASCADE'); });
